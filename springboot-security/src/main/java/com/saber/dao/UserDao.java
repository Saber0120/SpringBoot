...
public class UserDao {
    ...
    public SysUser selectByName(String username) {
        ...
        if ("zhangsan".equals(username)) {
            SysUser sysUser = new SysUser("zhangsan", "$2a$10$08xJp1uX5UBL/LtyfEK/5u2s5wDOUbS/vIoTuczNjKg7kp2P8W1He");
            sysUser.setRoleList(Arrays.asList(admin, developer));
            return sysUser;
        }else if ("lisi".equals(username)) {
            SysUser sysUser = new SysUser("lisi", "$2a$10$08xJp1uX5UBL/LtyfEK/5u2s5wDOUbS/vIoTuczNjKg7kp2P8W1He");

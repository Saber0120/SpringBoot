...
public class ByteSourceUtils {
    ...
    public static ByteSource bytes(String obj){
        return new MySimpleByteSource(obj.getBytes());
    }
}

// 原来的写法，在从redis中取出数据反序列化成对象时会报错:no valid constructor，经过百度改成下面的写法
/*
class SimpleByteSource extends org.apache.shiro.util.SimpleByteSource
        implements Serializable {

    private static final long serialVersionUID = 6902228239848190985L;
